        ...
        <AdminLayout>
            <div className="container-fluid py-2" style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column' }}>
                <h3 className='text-center text-dark mb-4'>
                    <i className='fas fa-list-alt me-1'></i>Details of Confirmed Orders
                </h3>
                    ...
                    <table className='table table-bordered table-striped table-hover'>
                        ...
                        <tbody>
                            {currentOrders.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="4" className="text-center">No confirmed orders found.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
